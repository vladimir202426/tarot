const tarotCards = {
    1: { name: "El Mago", image: "images/mago.jpg" },
    2: { name: "La Papisa (La Sacerdotisa)", image: "images/sacerdotisa.jpg" },
    3: { name: "La Emperatriz", image: "images/emperatriz.jpg" },
    4: { name: "El Emperador", image: "images/emperador.jpg" },
    5: { name: "El Sumo Sacerdote (El Papa)", image: "images/hierofante.jpg" },
    6: { name: "Los Enamorados", image: "images/enamorados.jpg" },
    7: { name: "El Carro", image: "images/carro.jpg" },
    8: { name: "La Justicia", image: "images/justicia.jpg" },
    9: { name: "El Ermitaño", image: "images/ermitano.jpg" },
    10: { name: "La Rueda de la Fortuna", image: "images/rueda_fortuna.jpg" },
    11: { name: "La Fuerza", image: "images/fuerza.jpg" },
    12: { name: "El Colgado", image: "images/colgado.jpg" },
    13: { name: "La Muerte", image: "images/muerte.jpg" },
    14: { name: "La Templanza", image: "images/templanza.jpg" },
    15: { name: "El Diablo", image: "images/diablo.jpg" },
    16: { name: "La Torre", image: "images/torre.jpg" },
    17: { name: "La Estrella", image: "images/estrella.jpg" },
    18: { name: "La Luna", image: "images/luna.jpg" },
    19: { name: "El Sol", image: "images/sol.jpg" },
    20: { name: "El Juicio", image: "images/juicio.jpg" },
    21: { name: "El Mundo", image: "images/mundo.jpg" },
    22: { name: "El Loco", image: "images/loco.jpg" }
};
...
function calculateTarot(event) {
    ...
    const sum = [year, month, day].reduce((acc, num) => acc + num, 0);
    let total = sum.toString().split('').reduce((acc, num) => acc + Number(num), 0);

    if (total > 22) {
        total = total.toString().split('').reduce((acc, num) => acc + Number(num), 0);
    }

    const card = tarotCards[total];
    const description = tarotMeanings[total] || 'No se encontró la carta.';
    ...
    document.getElementById('calculationProcess').textContent = `Proceso de cálculo: ${year} + ${month} + ${day} = ${sum} => ${total}`;
}
